<?php
if(!isset($_GET['id'])) {
    header('location: /default/pages/forecast');
    exit;
} else {
    $id = $_GET['id'];
    // get news
    $forecast = $cnt->getDataUser("f_forecasts", "WHERE `id`='$id' AND `status`='1'");
    // check news
    if(!$forecast) {
        header('location: /default/pages/forecast');
        exit;
                ...
                <div class="container">
                    ...
                    <div id="nav-node-list">
                        <ul class="row">
                            <li>
                                <a href="/">Главная</a>
                                <a href="/pages/forecasts">Прогнозы</a>
                                <span><?=$forecast['title_ru']?></span>
                            </li>
                        </ul>
                    </div>

                    <!-- comment to forecast -->
                    <div id="commentForecast">
                        <div class="comment-block">
                            <p>Комментраирй к прогнозу</p>
                        </div>
                        <div class="forecast-info">
                            ...
                            <h1><?=$forecast['title_ru']?></h1>
                            <p><?=decodeText($forecast['descr_ru']);?></p>
                        </div>
                    </div>
                    
                    <?php
                    $sucess_forecasts = $cnt->getDataUser("f_forecasts", "WHERE `id`='$id' AND `status`='1' AND `success`='1'");
                                ...
                                <div class="moreInfoForecBox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lig-forec">
                                            ...
                                            <img src="/public/img/<?=$t_2_logo_src?>" alt="End Team">
                                        </div>
                                    </div>
                                    <table>
                                        <tr>
