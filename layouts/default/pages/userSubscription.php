	...
	<article class="indexContentBody row">
		<section id="headerNews">
			...
			<div class="container-row">
				...
				<div id="news-block">
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP1.png" alt="newsP1.png"></span>
							<span class="news-card-body">
								<span class="news-header">Почеттино: «Если мы выиграем ЛЧ, решение выпустить Кейна покажется всем фантастическим»</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP2.png" alt="newsP2.png"></span>
							<span class="news-card-body">
								<span class="news-header">Фабри Гонсалес покинул Карпаты</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP3.png" alt="newsP3.png"></span>
							<span class="news-card-body">
								<span class="news-header">Джампаоло может покинуть Сампдорию </span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP4.png" alt="newsP4.png"></span>
							<span class="news-card-body">
								<span class="news-header">В финале плей-офф за выход в Серию А сыграют Читтаделла и Верона</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP5.png" alt="newsP5.png"></span>
							<span class="news-card-body">
								<span class="news-header">Зидан хочет сохранить Рамоса в команде</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP6.png" alt="newsP6.png"></span>
							<span class="news-card-body">
								<span class="news-header">Астон Вилла — Дерби: Томори и Маунт выйдут в старте</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP7.png" alt="newsP7.png"></span>
							<span class="news-card-body">
								<span class="news-header">Алибеков: В команде хороший микроклимат  </span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP8.png" alt="newsP8.png"></span>
							<span class="news-card-body">
								<span class="news-header">Манчестер Сити будет следить за Ло Чельсо на Копа Америка</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP9.png" alt="newsP9.png"></span>
							<span class="news-card-body">
								<span class="news-header">У Наполи нет свободных денег на трансферы</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP10.png" alt="newsP10.png"></span>
							<span class="news-card-body">
								<span class="news-header">Кузен хозяина Манчестер Сити хочет купить Ньюкасл за 350 миллионов фунтов</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP11.png" alt="newsP11.png"></span>
							<span class="news-card-body">
								<span class="news-header">Увольнение Спаллетти обойдется Интеру в 25 миллионов евро</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
					<div class="box">
						<a href="newsID.html" class="news-card">
							<span class="news-img"><img src="img/news/newsP12.png" alt="newsP12.png"></span>
							<span class="news-card-body">
								<span class="news-header">Серия А: триумф Аталанты, удача Интера, прощальная гастроль Эмполи и другие итоги 38-го тура</span> 
								<span class="news-date">22.06.2018 : 03:34</span>
							</span>
						</a>
					</div>
			...
			<div class="container">
						...
						<div class="row">
							...
							<div class="personalAre-navbar">
								...
								<ul class="row personalAre-navbar-body">
									<li><a  href="user.html">Актуальные прогнозы</a></li>
									<li><a href="#">Архив прогнозов</a></li>
									<li><a class="active" href="userSubscription.html">Подписка</a></li>
				...
				<div class="alert alert-warring ">
					<div class="row">
						...
						<div class="col-alert">
							<button class="btn alert-close" type="button">ЗАКРЫТЬ</button>
						</div>
					</div>
				</div>
				...
				<div class="alert alert-danger ">
					<div class="row">
						...
						<div class="col-alert">
							<button class="btn alert-go" type="button">продлить</button>
						</div>
					</div>
				</div>
				<!-- alert block end -->
						...
						<div class="sub-info">
							...
							<ul>
								...
								<li>
									...
									<span>1 неделя доступа в vip-чат с Live прогнозами</span>
								</li>
								<li>
									<span class="icon">
										<svg id="Group_142" data-name="Group 142" xmlns="http://www.w3.org/2000/svg" width="13.304" height="13.304" viewBox="0 0 13.304 13.304">
									...
									<span>Доступ ко всем прогнозам</span>
								</li>
								<li>
									<span class="subscript-active show icon"> <!--add show if wont this-->
										<svg id="Group_142" data-name="Group 142" xmlns="http://www.w3.org/2000/svg" width="13.304" height="13.304" viewBox="0 0 13.304 13.304">
										  	<ellipse id="Ellipse_3" data-name="Ellipse 3" cx="6.652" cy="6.652" rx="6.652" ry="6.652" fill="#2ab700"/>
										  	<path id="Path_132" data-name="Path 132" d="M2.361,64.552a.519.519,0,0,1-.368-.152L.153,62.56a.52.52,0,1,1,.736-.736L2.361,63.3l3.312-3.312a.52.52,0,0,1,.736.736L2.729,64.4A.519.519,0,0,1,2.361,64.552Z" transform="translate(3.501 -55.63)" fill="#fff"/>
										</svg>
									</span>
									<span class="subscript-notactive icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 28.235 28.235">
										  	<path id="Path_8981" data-name="Path 8981" d="M24.1,4.13a14.124,14.124,0,1,0,0,19.975A14.14,14.14,0,0,0,24.1,4.13ZM19.687,19.687a1.086,1.086,0,0,1-1.536,0l-4.034-4.034L9.892,19.879a1.086,1.086,0,0,1-1.536-1.536l4.225-4.225L8.548,10.084a1.086,1.086,0,0,1,1.536-1.536l4.033,4.034L17.959,8.74a1.086,1.086,0,1,1,1.536,1.536l-3.841,3.841,4.034,4.034A1.086,1.086,0,0,1,19.687,19.687Z" transform="translate(0 0)" fill="#F30D31"/>
										</svg>
									</span>
									<span>Активно до 20/09/2018</span>
								</li>
								<li class="sub-btn">
									<button type="button" class="btn btn-continue-sub">ПРОДЛИТЬ ТАРИФ</button>
								</li>
							</ul>
						</div>
					</div>
