        ...
        <article class="indexContentBody row">
            ...
            <section id="pageContent">
                <div class="container">
                    <!-- news page big box --> 
                    <div id="newsBigBox">
                        <div id="newsBigHeader" class="row">
                            <div class="col-news">
                                <h2>Новости</h2>
                            </div>
                            <div class="col-news-data">
                                <ul class="row">
                        ...
                        <div class="row newsCardsBlock">
                            <?php foreach($cnt->getDataUser("f_news", "WHERE `status`='1'", "all") as $news) {
                                $news_id = $news['id'];
                                ...
                                if ($news_image) {
                                    ...
                                    $news_show = '/public/img/f_news/large/'.$news_img_name.'.'.$news_img_type;
                                }else {
                                    $news_show = '/public/img/no_photo.jpg';
                                }

                            ?>
                            <div class="col-news">
                                <a href="newsID?id=<?=$news_id?>" class="news-card">
                                    <div class="card-img">
                                        <img src="<?=$news_show?>">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="moreNews-btn">
                            <button class="btn" type="button"><span>Еще</span></button>
                        </div>
                    </div>
