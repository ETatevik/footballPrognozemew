            ...
            <section id="pageContent">
                <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="personalAre-navbar">
                                    ...
                                    <ul class="row personalAre-navbar-body">
                                        ...
                                        <li><a class="active"  href="userSetting.html">Настройки аккаунта</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="ligaFootball">
                        <div class="userData-body">
                            <form  action="" autocomplete="off">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-col">
                                            <label  for="nameUserMD">
                                                <span>Имя</span>
                                                <input type="text" id="nameUserMD" value="Николай">
                                            </label>
                                            <div class="invalid">* Error</div> <!--input class error-->
                                        </div>
                                        <div class="form-col">
                                            <label  for="nameUserMD">
                                                <span>Фамилия</span>
                                                <input  type="text" id="nameUserMD" value="Беллуян">
                                            </label>
                                            <div class="invalid">* Error</div> <!--input class error-->
                                        </div>
                                        <div class="form-col">
                                            <label  for="regEmailUserMD">
                                                <span>Эл. Почта</span>
                                                <input  type="email" id="regEmailUserMD" value="niko@gmail.com">
                                            </label>
                                            <div class="invalid">* Error</div> <!--input class error-->
                                        </div>
                                    </div>
                        ...
                        <div class="userData-body" id="userDataSetting">
                            <form  action="" autocomplete="off">
                                <div class="form-group">
                                    <div class="form-col-100">
                                        <h4>Изменеие тарифа</h4>
                                    </div>
                                    <div class="form-col form-select-user">
