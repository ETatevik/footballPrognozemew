<?php 
// get data
$page = $cnt->getDataUser("pages", "WHERE `filename`='about' AND `status`='1'");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="container">
                    ...
                    <div id="newsIdBox"> 
                        <div id="newsArticleBody">
                            <p class="news-date">22.06.2018 : 03:34</p>
                            <div class="news-Id-Info">
                                <h1 class="news-head"><?=$page['title_ru']?></h1>
                                <?php echo decodeText($page['descr']);?>
                            </div>
                        </div>
                                    ...
                                    <ul id="recommend-slider" class="recommend-slider">
                                        <li>
                                            <div class="col-news">
                                                <a href="newsID.html" class="news-card">
                                                    <div class="card-img">
                                                        <img src="/public/img/news/newsG1.png" alt="newsG1.png">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5>МВД возбудило уголовное дело о договорном матче. За поражение футболистам заплатили два миллиона рублей</h5>
                                                        <p>22.06.2018 : 03:34</p>
                                                    </div>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-news">
                                                <a href="newsID.html" class="news-card">
                                                    <div class="card-img">
                                                        <img src="/public/img/news/newsG2.png" alt="newsG2.png">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5>Коноплянка впервые за два года начнет матч сборной Украины на скамейке запасных – прошлая встреча завершилась поражением</h5>
                                                        <p>22.06.2018 : 03:34</p>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-news">
                                                <a href="newsID.html" class="news-card">
                                                    <div class="card-img">
                                                        <img src="/public/img/news/newsG3.png" alt="newsG3.png">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5>Давинсон Санчес грубо толкнул Неймара в рекламный щит – бразилец был не готов к такому «приветствию</h5>
                                                        <p>22.06.2018 : 03:34</p>
                                                    </div>
                                                </a>
                                            </div>
                                        <li>
                                            <div class="col-news">
                                                <a href="newsID.html" class="news-card">
                                                    <div class="card-img">
                                                        <img src="/public/img/news/newsG4.png" alt="newsG4.png">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5>Юный рекордсмен Барселоны решил выступать за сборную Испании – он имел шанс играть в составе соперника сборной Украины</h5>
                                                        <p>22.06.2018 : 03:34</p>
                                                    </div>
                                                </a>
                                            </div>
